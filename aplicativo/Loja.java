...
public class Loja extends JFrame implements ActionListener, ComponentListener, AdjustmentListener{
    ...
    ImageIcon Whey_original = new ImageIcon(getClass().getResource("imagens/whey.png"));
    ...
    ImageIcon toalha_original = new ImageIcon(getClass().getResource("imagens/toalha.png"));
...
public Loja() {
    ...
    public void loja(){
        ...
        prod_1.setBounds(100,200,largura_atual/10,200);

        prod_2.setBounds(300,200,largura_atual/10,200);

        prod_3.setBounds(400,200,largura_atual/10,200);

        prod_4.setBounds(700,200,largura_atual/10,200);

        prod_5.setBounds(900,200,largura_atual/10,200);
